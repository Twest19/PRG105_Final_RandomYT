...
print("\nConversion:")
print(f"{user_servings} / {recipe_servings} = {user_servings / recipe_servings} * amount needed for each ingredient\n")
...
print(f"\t- {butter * conversion1:.2f} cup(s) of butter\n"
      ...
      f"\t- {cocoa1 * conversion1:.2f} cup(s) and {cocoa2 * conversion1} tbsp. and {cocoa3 * conversion1} tsp. unsweetened cocoa powder\n"
